...
environment:  ## create environment
	...
	pyenv virtualenv 3.6.9 pycollect
	pyenv local pycollect
...
black:  ## apply the Black code style to code
	black --exclude="build/|buck-out/|dist/|_build/|pip/|env/|\.pip/|\.git/\
	|\.hg/|\.mypy_cache/|\.tox/|\.venv/" .

.PHONY: tests
tests:  ## run tests with pytest
	python setup.py develop
	python -m pytest --cov=src/pycollect --cov-report term --cov-report html:htmlcov \
